...
```bash
python experiment.py --json results.json --html report.html
```

### Programmatic

```python
from modelext import BlackBoxOracle, run_extraction
from modelext import AdaptiveStrategy
from modelext import SubstituteTrainer
from modelext import ExtractionAttack, ExtractionConfig
